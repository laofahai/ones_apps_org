...
class PurchaseDetailViewModel extends CommonViewModel {
    ...
    protected $viewFields = array(
        ...
        "Goods"  => array("name"=>"goods_name", "pinyin"=>"goods_pinyin", "measure","factory_code", "price"=>'source_price', "goods_category_id", "_on" => "Goods.id=PurchaseDetail.goods_id", "_type"=>"left"),
    );
